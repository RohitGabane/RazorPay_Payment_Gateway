...
namespace Payment_Gateway.Controllers
{
    ...
    {
        private readonly RegistrationModelDbContext registrationModelDbContext;
        public PaymentController(RegistrationModelDbContext registrationModelDbContext)
        {
            this.registrationModelDbContext = registrationModelDbContext;
        }
        private const string _key = "rzp_test_tckF26XAelxHhe";
        private const string _secret = "y2xwNgsJGK09gGVDiuox4eLh";
        ...
        public ViewResult Payment(RegistrationModel registration)
        {
            ...
            RazorPayOptionsModel razorPayOptions = new RazorPayOptionsModel()
            {
                ...
                Name = "Amazatics",
                Description = "Salary_Distribution",
                ImageLogUrl = "",
                OrderId = orderId,
